...
public class GifCaptcha extends Captcha {
    ...
    public void out(OutputStream os) {
        try {
            ...
            for (int i = 0; i < len; i++) {
                fontcolor[i] = new Color(20 + RandomUtil.num(110), 20 + RandomUtil.num(110), 20 + RandomUtil.num(110));
            }
            for (int i = 0; i < len; i++) {
    ...
    private BufferedImage graphicsImage(Color[] fontcolor, char[] strs, int flag) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            g2d.drawOval(RandomUtil.num(width), RandomUtil.num(height), 5 + RandomUtil.num(10), 5 + RandomUtil.num(10));
